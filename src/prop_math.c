...
int m_print(double m_to_print[3][3], char name[256]) {
    int c, d;
...
int m_print6(double m_to_print[6][6], char name[256]) {
    int c, d;
...
int m_print6_temp(double m_to_print[6][6], char name[256]) {
    int c, d;
...
int m_print9_temp(double m_to_print[9][9], char name[256]) {
    int c, d;
...
int m_print8_temp(double m_to_print[8][8], char name[256]) {
    int c, d;
...
int v_norm_print(double v_to_print_norm[3], char name[256]) {
    double norm = 0.0;
...
int v_print(double v_to_print[3], char name[256]) {
    printf("%s: (%.8e, %.8e, %.8e)\n", name, v_to_print[0], v_to_print[1], v_to_print[2]);
    return 0;
}

int v_print6(double v_to_print[6], char name[256]) {
    printf("%s: (%.6e, %.6e, %.6e) (%.6e, %.6e, %.6e)\n", name, v_to_print[0], v_to_print[1],
           v_to_print[2], v_to_print[3],
           v_to_print[4], v_to_print[5]);
    return 0;
}

int v_print7(double v_to_print[7], char name[256]) {
    printf("%s: (%.7f, %.7f, %.7f) (%.7f, %.7f, %.7f) %.7f\n", name, v_to_print[0],
           v_to_print[1], v_to_print[2], v_to_print[3], v_to_print[4],
           v_to_print[5], v_to_print[6]);
    return 0;
}

//Vector and Matrix math
// Compute the vector magnitude
int v_mag(double *v_mag, double v_in[3]) {
...
//Compute the vector magnitude
int v_mag6(double *v_mag, double v_in[6]) {

    v_mag[0] = sqrt(v_in[0] * v_in[0] + v_in[1] * v_in[1] + v_in[2] * v_in[2] + v_in[3] * v_in[3] +
                    v_in[4] * v_in[4] + v_in[5] * v_in[5]);
    return 0;
}

//Compute the normal vector(3 - dimension)
int v_norm(double u_out[3], double v_in[3]) {
    double v_in_mag;
    int ii;
...
int v_norm6(double u_out[6], double v_in[6]) {
    double v_in_mag;
    int ii;
...
int v_dot(double *dot, double v1[3], double v2[3]) {
...
int v_cross(double v_cross[3], double v1[3], double v2[3]) {
...
//Scale a vector
int v_scale(double v_out[3], double v_in[3], double scale) {
...
//Subtract vectors
int v_sub(double v_out[3], double v1[3], double v2[3]) {
...
//Add vectors
int v_add(double v_out[3], double v1[3], double v2[3]) {
...
//Copy vectors
int v_copy(double v_out[3], double v_in[3]) {
...
//Copy matrices
int m_copy(double m_out[3][3], double m_in[3][3]) {
...
//Copy matrices
int m_copy6(double m_out[6][6], double m_in[6][6]) {
...
//Matrix x Vector
int m_x_v(double v_out[3], double m_in[3][3], double v_in[3]) {
...
//Matrix x Vector
int m_x_v6(double v_out[6], double **m_in, double v_in[6]) {
    v_out[0] = m_in[0][0] * v_in[0] + m_in[0][1] * v_in[1] + m_in[0][2] * v_in[2] + m_in[0][3] * v_in[3]
               + m_in[0][4] * v_in[4] +
               m_in[0][5] * v_in[5];
    v_out[1] = m_in[1][0] * v_in[0] + m_in[1][1] * v_in[1] + m_in[1][2] * v_in[2] + m_in[1][3] * v_in[3]
               + m_in[1][4] * v_in[4] +
               m_in[1][5] * v_in[5];
    v_out[2] = m_in[2][0] * v_in[0] + m_in[2][1] * v_in[1] + m_in[2][2] * v_in[2] + m_in[2][3] * v_in[3]
               + m_in[2][4] * v_in[4] +
               m_in[2][5] * v_in[5];
    v_out[3] = m_in[3][0] * v_in[0] + m_in[3][1] * v_in[1] + m_in[3][2] * v_in[2] + m_in[3][3] * v_in[3]
               + m_in[3][4] * v_in[4] +
               m_in[3][5] * v_in[5];
    v_out[4] = m_in[4][0] * v_in[0] + m_in[4][1] * v_in[1] + m_in[4][2] * v_in[2] + m_in[4][3] * v_in[3]
               + m_in[4][4] * v_in[4] +
               m_in[4][5] * v_in[5];
    v_out[5] = m_in[5][0] * v_in[0] + m_in[5][1] * v_in[1] + m_in[5][2] * v_in[2] + m_in[5][3] * v_in[3]
               + m_in[5][4] * v_in[4] +
               m_in[5][5] * v_in[5];
    return 0;
}

int m_x_v6bis(double v_out[6], double m_in[6][6], double v_in[6]) {
    v_out[0] = m_in[0][0] * v_in[0] + m_in[0][1] * v_in[1] + m_in[0][2] * v_in[2] + m_in[0][3] * v_in[3]
               + m_in[0][4] * v_in[4] +
               m_in[0][5] * v_in[5];
    v_out[1] = m_in[1][0] * v_in[0] + m_in[1][1] * v_in[1] + m_in[1][2] * v_in[2] + m_in[1][3] * v_in[3]
...
//Matrix Transpose
int m_trans(double m_out[3][3], double m_in[3][3]) {
    m_out[0][1] = m_in[1][0];
    m_out[0][2] = m_in[2][0];
...
//Matrix Transpose
int m_trans6(double m_out[6][6], double m_in[6][6]) {
    int i, j;
    for(i = 0; i < 6; i++) {
        for(j = 0; j < 6; j++) {
            m_out[i][j] = m_in[j][i];
...
//Vallado 03:fmod(lam - *arg_per - *raan, 2 * M_PI);
    ...
    double r_eq[9];
    r_eq[0] = *sma * 1e-3;
    //a = (mu / n ^ 2) ^ (1 / 3) in km for eqncpv_c
    r_eq[1] = ag;
    r_eq[2] = af;
    r_eq[3] = lam;
    r_eq[4] = chi;
...
int compute_T_deriv_equin_to_class(double T_equin_2_class[6][6], double af,
    ...
    T_equin_2_class[0][0] = -2. / (3 * n) * pow(mu / (n * n), 1. / 3);
    T_equin_2_class[0][1] = 0;
    T_equin_2_class[0][2] = 0;
    T_equin_2_class[0][3] = 0;
    T_equin_2_class[0][4] = 0;
    T_equin_2_class[0][5] = 0;
    //da / d
    T_equin_2_class[1][0] = 0;
    T_equin_2_class[1][1] = af / sqrt(den1);
    T_equin_2_class[1][2] = ag / sqrt(den1);
    T_equin_2_class[1][3] = 0;
    T_equin_2_class[1][4] = 0;
    T_equin_2_class[1][5] = 0;
    //de / d
    T_equin_2_class[2][0] = 0;
    T_equin_2_class[2][1] = 0;
    T_equin_2_class[2][2] = 0;
    T_equin_2_class[2][3] = 2 * fr * chi / den2;
    T_equin_2_class[2][4] = 2 * fr * psi / den2;
    T_equin_2_class[2][5] = 0;
    //di / d
    T_equin_2_class[3][0] = 0;
    T_equin_2_class[3][1] = 0;
    T_equin_2_class[3][2] = 0;
    T_equin_2_class[3][3] = psi / den3;
    T_equin_2_class[3][4] = -chi / den3;
    T_equin_2_class[3][5] = 0;
    //do / d
    T_equin_2_class[4][0] = 0;
    T_equin_2_class[4][1] = -ag / den1;
    T_equin_2_class[4][2] = af / den1;
    T_equin_2_class[4][3] = -fr * psi / den3;
    T_equin_2_class[4][4] = fr * chi / den3;
    T_equin_2_class[4][5] = 0;
    //dw / d
    T_equin_2_class[5][0] = 0;
    T_equin_2_class[5][1] = ag / den1;
    T_equin_2_class[5][2] = -af / den1;
    T_equin_2_class[5][3] = 0;
    T_equin_2_class[5][4] = 0;
    T_equin_2_class[5][5] = 1;
    //dM / d
...
int cart_to_equin(double *af, double *ag, double *lam, double *n, double *chi,
    ...
    *psi = -w[1] / (1 + fr * w[2]);
    ...
    f[0] = (1 - (*chi) * (*chi) + (*psi) * (*psi)) * coeff;
    f[1] = 2 * (*chi) * (*psi) * coeff;
    f[2] = -2 * fr * (*chi) * coeff;
    g[0] = 2 * fr * (*chi) * (*psi) * coeff;
    g[1] = (1 + (*chi) * (*chi) - (*psi) * (*psi)) * fr * coeff;
    g[2] = 2 * (*psi) * coeff;
    ...
    double x, y;
    v_dot(&x, rvec, f);
    //rvec in km but then in sinf and cosf a is in km so need to to keep km here too
    v_dot(&y, rvec, g);
    double b = 1. / (1 + sqrt(1 - (*ag) * (*ag) - (*af) * (*af)));
    double sinf = (*ag) + ((1 - (*ag) * (*ag) * b) * y - (*ag) * (*af) * b * x) / (a * sqrt(1 -
                  (*ag) * (*ag) - (*af) * (*af)));
    double cosf = (*af) + ((1 - (*af) * (*af) * b) * x - (*ag) * (*af) * b * y) / (a * sqrt(1 -
                  (*ag) * (*ag) - (*af) * (*af)));
    double F = atan2(sinf, cosf);
    *lam = F + (*ag) * cosf - (*af) * sinf;
...
int equin_to_cart(double rvec[3], double vvec[3], double af, double ag,
    ...
    while(err > err_max) {
        fiplus = fi - (fi + ag * cos(fi) - af * sin(fi) - lam) / (1 - ag * sin(fi) - af * cos(fi));
        fi = fiplus;
        lamguess = fi + ag * cos(fi) - af * sin(fi);
    ...
    f[0] = 1 - chi * chi + psi * psi;
    f[1] = 2 * chi * psi;
    f[2] = -2 * fr * chi;
    g[0] = 2 * fr * chi * psi;
    g[1] = (1 + chi * chi - psi * psi) * fr;
    g[2] = 2 * psi;
    w[0] = 2 * chi;
    w[1] = -2 * psi;
    w[2] = (1 - chi * chi - psi * psi) * fr;
    ...
    double sinl = ((1 - af * af * b) * sin(F) + ag * af * b * cos(F) - ag) / (1 - ag * sin(
                           F) - af * cos(F));
    double cosl = ((1 - ag * ag * b) * cos(F) + ag * af * b * sin(F) - af) / (1 - ag * sin(
                           F) - af * cos(F));
...
equin_to_cart(double T_equin_to_cart[6][6], double af, double ag, double lam, double n, double chi,
              double psi, double mu, double fr) {
    ...
    double r, v;
    v_mag(&r, rvec);
    //!!!!!not sure check with danielson95
    v_mag(&v, vvec);
    //!!!!!not sure check with danielson95
    ...
    T_equin_to_cart[0][3] = 2 * (fr * psi * (y * fe - x * ge) - x * we) / C;
    T_equin_to_cart[0][4] = 2 * fr * (chi * (x * ge - y * fe) + y * we) / C;
    T_equin_to_cart[0][5] = vx / n;
    //drx / d
    T_equin_to_cart[1][0] = -2 * ry / (3 * n);
    T_equin_to_cart[1][1] = dxdaf * fq + dydaf * gq;
    T_equin_to_cart[1][2] = dxdag * fq + dydag * gq;
    T_equin_to_cart[1][3] = 2 * (fr * psi * (y * fq - x * gq) - x * wq) / C;
    T_equin_to_cart[1][4] = 2 * fr * (chi * (x * gq - y * fq) + y * wq) / C;
    T_equin_to_cart[1][5] = vy / n;
    //drx / d
    T_equin_to_cart[2][0] = -2 * rz / (3 * n);
    T_equin_to_cart[2][1] = dxdaf * fw + dydaf * gw;
    T_equin_to_cart[2][2] = dxdag * fw + dydag * gw;
    T_equin_to_cart[2][3] = 2 * (fr * psi * (y * fw - x * gw) - x * ww) / C;
    T_equin_to_cart[2][4] = 2 * fr * (chi * (x * gw - y * fw) + y * ww) / C;
    T_equin_to_cart[2][5] = vz / n;
    //drx / d
    T_equin_to_cart[3][0] = vx / (3 * n);
    T_equin_to_cart[3][1] = dxdotdaf * fe + dydotdaf * ge;
    T_equin_to_cart[3][2] = dxdotdag * fe + dydotdag * ge;
    T_equin_to_cart[3][3] = 2 * (fr * psi * (ydot * fe - xdot * ge) - xdot * we) / C;
    T_equin_to_cart[3][4] = 2 * fr * (chi * (xdot * ge - ydot * fe) + ydot * we) / C;
    T_equin_to_cart[3][5] = -n * a3 * rx / r3;
    //drx / d
    T_equin_to_cart[4][0] = vy / (3 * n);
    T_equin_to_cart[4][1] = dxdotdaf * fq + dydotdaf * gq;
    T_equin_to_cart[4][2] = dxdotdag * fq + dydotdag * gq;
    T_equin_to_cart[4][3] = 2 * (fr * psi * (ydot * fq - xdot * gq) - xdot * wq) / C;
    T_equin_to_cart[4][4] = 2 * fr * (chi * (xdot * gq - ydot * fq) + ydot * wq) / C;
    T_equin_to_cart[4][5] = -n * a3 * ry / r3;
    //drx / d
    T_equin_to_cart[5][0] = vz / (3 * n);
    T_equin_to_cart[5][1] = dxdotdaf * fw + dydotdaf * gw;
    T_equin_to_cart[5][2] = dxdotdag * fw + dydotdag * gw;
    T_equin_to_cart[5][3] = 2 * (fr * psi * (ydot * fw - xdot * gw) - xdot * ww) / C;
    T_equin_to_cart[5][4] = 2 * fr * (chi * (xdot * gw - ydot * fw) + ydot * ww) / C;
    T_equin_to_cart[5][5] = -n * a3 * rz / r3;
    //drx / d
...
int compute_T_deriv_class_to_cart(double T_class_to_cart[6][6], double a,
    ...
    double c2 = -(2 * a * e + a * cos(nu) + a * e * e * cos(nu)) / ((1 + e * cos(nu)) * (1 + e * cos(
                         nu)));
    double c3 = c1 / (1 + e * cos(nu));
    ri[0] = c1 * (cos(nu) * (cos(big_omega) * cos(small_omega) - sin(big_omega) * sin(
            small_omega) * cos(i)) - sin(nu) * (cos(big_omega) * sin(small_omega) +
            sin(big_omega) * cos(small_omega) * cos(i)));
    ri[1] = c2 * (cos(nu) * (cos(big_omega) * cos(small_omega) - sin(big_omega) * sin(
            small_omega) * cos(i)) - sin(
                                  nu) * (cos(big_omega) * sin(small_omega) + sin(big_omega) * cos(small_omega) * cos(i)));
    ri[2] = a * c1 * sin(big_omega) * sin(i) * (cos(nu) * sin(small_omega) + sin(nu) * cos(
                            small_omega));
    ri[3] = a * c1 * (-cos(nu) * sin(big_omega) * cos(small_omega) - cos(nu) * cos(
                                      big_omega) * sin(
                                      small_omega) * cos(i) + sin(nu) * sin(big_omega) * sin(small_omega) - sin(nu) * cos(
                                      big_omega) * cos(small_omega) * cos(i));
    ri[4] = a * c1 * (-cos(nu) * cos(big_omega) * sin(small_omega) - cos(nu) * sin(
                                      big_omega) * cos(
                                      small_omega) * cos(i) - sin(nu) * cos(big_omega) * cos(small_omega) + sin(nu) * sin(
                                      big_omega) * sin(small_omega) * cos(i));
    ri[5] = a * c3 * (-sin(nu) * (cos(big_omega) * cos(small_omega) - sin(big_omega) * sin(
                                      small_omega) * cos(i)) +
                                  (e + cos(nu)) * (-cos(big_omega) * sin(small_omega) - sin(big_omega) * cos(small_omega) * cos(i)));

    double rj[6];
    //it's not rj, just a notation
    double c4 = sqrt(mu / (a * (1 - e * e)));
    rj[0] = c1 * (cos(nu) * sin(big_omega) * cos(small_omega) + cos(nu) * cos(
                                  big_omega) * sin(small_omega) * cos(
                                  i) - sin(nu) * sin(big_omega) * sin(small_omega) + sin(nu) * cos(big_omega) * cos(
                                  small_omega) * cos(i));
    rj[1] = c2 * (cos(nu) * (sin(big_omega) * cos(small_omega) + cos(big_omega) * sin(
            small_omega) * cos(i)) + sin(
                                  nu) * (-sin(big_omega) * sin(small_omega) + cos(big_omega) * cos(small_omega) * cos(i)));
    rj[2] = -a * c1 * cos(big_omega) * sin(i) * (cos(nu) * sin(small_omega) + sin(nu) * cos(
                            small_omega));
    rj[3] = a * c1 * (cos(nu) * cos(big_omega) * cos(small_omega) - cos(nu) * sin(
                                      big_omega) * sin(
                                      small_omega) * cos(i) - sin(nu) * cos(big_omega) * sin(small_omega) - sin(nu) * sin(
                                      big_omega) * cos(small_omega) * cos(i));
    //line below from Vallado 2015
    //rj[3] = a * c1 * (cos(nu) * (sin(big_omega) * cos(small_omega) + cos(big_omega) * sin(small_omega) * cos(i)) + sin(nu) * (-sin(big_omega) * sin(small_omega) + cos(big_omega) * cos(small_omega) * cos(i)));
    rj[4] = a * c1 * (-cos(nu) * sin(big_omega) * sin(small_omega) + cos(nu) * cos(
                                      big_omega) * cos(
                                      small_omega) * cos(i) - sin(nu) * sin(big_omega) * cos(small_omega) - sin(nu) * cos(
                                      big_omega) * sin(small_omega) * cos(i));
    rj[5] = a * c3 * (-sin(nu) * (sin(big_omega) * cos(small_omega) + cos(big_omega) * sin(
                                      small_omega) * cos(i)) +
                                  (e + cos(nu)) * (-sin(big_omega) * sin(small_omega) + cos(big_omega) * cos(small_omega) * cos(i)));

    double rk[6];
    //it's not rk, just a notation
    rk[0] = c1 * (cos(nu) * sin(small_omega) * sin(i) + sin(nu) * cos(small_omega) * sin(
                                  i));
    rk[1] = c2 * (cos(nu) * sin(small_omega) * sin(i) + sin(nu) * cos(small_omega) * sin(
                                  i));
    rk[2] = a * c1 * cos(i) * (cos(nu) * sin(small_omega) + sin(nu) * cos(small_omega));
    rk[3] = 0;
    rk[4] = a * c1 * sin(i) * (cos(nu) * cos(small_omega) - sin(nu) * sin(small_omega));
    rk[5] = a * c3 * (-sin(nu) * sin(small_omega) * sin(i) + (e + cos(nu)) * cos(
                                      small_omega) * sin(i));


    double vi[6];
    //it 's not vi, just a notation
    c3 = sqrt(mu / (a * (1 - e * e)));
    vi[0] = 1 / (2 * a) * c3 * (sin(nu) * (cos(big_omega) * cos(small_omega) - sin(
            big_omega) * sin(
                    small_omega) * cos(i)) - (e + cos(nu)) * (-cos(big_omega) * sin(small_omega) - sin(big_omega) * cos(
                            small_omega) * cos(i)));
    //!!!!looks like there s a typo in the equation online cos((w * cos(i)))
    vi[1] = 1 / (1 - e * e) * c3 * (-e * sin(nu) * (cos(big_omega) * cos(small_omega) - sin(
                            big_omega) * sin(
                            small_omega) * cos(i)) + (1 + e * cos(nu)) * (-cos(big_omega) * sin(small_omega) - sin(
                                        big_omega) * cos(small_omega) * cos(
                                        i)));
    //!!!!looks like there s a typo in the equation online cos((w * cos(i)))
    vi[2] = c3 * sin(big_omega) * (sin(nu) * sin(small_omega) * sin(i) + (e + cos(
                            nu)) * cos(small_omega) * sin(i));
    vi[3] = c3 * (sin(nu) * sin(big_omega) * cos(small_omega) + sin(nu) * cos(
                                  big_omega) * sin(small_omega) * cos(
                                  i) + (e + cos(nu)) * (sin(big_omega) * sin(small_omega) - cos(big_omega) * cos(small_omega) * cos(
                                          i)));
    vi[4] = c3 * (sin(nu) * cos(big_omega) * sin(small_omega) + sin(nu) * sin(
                                  big_omega) * cos(small_omega) * cos(
                                  i) + (e + cos(nu)) * (-cos(big_omega) * cos(small_omega) + sin(big_omega) * sin(small_omega) * cos(
                                          i)));
    vi[5] = c3 * (-cos(nu) * (cos(big_omega) * cos(small_omega) - sin(big_omega) * sin(
            small_omega) * cos(i)) - sin(
                                  nu) * (-cos(big_omega) * sin(small_omega) - sin(big_omega) * cos(small_omega) * cos(i)));

    double vj[6];
    //it's not vj, just a notation
    vj[0] = 1 / (2 * a) * c3 * (sin(nu) * (sin(big_omega) * cos(small_omega) + cos(
            big_omega) * sin(
                    small_omega) * cos(i)) - (e + cos(nu)) * (-sin(big_omega) * sin(small_omega) + cos(big_omega) * cos(
                            small_omega) * cos(i)));
    //!!!!looks like there s a typo in the equation online cos((w * cos(i)))
    vj[1] = 1 / (1 - e * e) * c3 * (-e * sin(nu) * (sin(big_omega) * cos(small_omega) + cos(
                            big_omega) * sin(
                            small_omega) * cos(i)) + (1 + e * cos(nu)) * (-sin(big_omega) * sin(small_omega) + cos(
                                        big_omega) * cos(small_omega) * cos(
                                        i)));
    //!!!!looks like there s a typo in the equation online cos((w * cos(i)))
    vj[2] = c3 * (sin(nu) * cos(big_omega) * sin(small_omega) * sin(i) - (e + cos(
                                  nu)) * cos(big_omega) * cos(
                                  small_omega) * sin(i));
    vj[3] = c3 * (-sin(nu) * cos(big_omega) * cos(small_omega) + sin(nu) * sin(
                                  big_omega) * sin(small_omega) * cos(
                                  i) + (e + cos(nu)) * (-cos(big_omega) * sin(small_omega) - sin(big_omega) * cos(small_omega) * cos(
                                          i)));
    vj[4] = c3 * (sin(nu) * sin(big_omega) * sin(small_omega) - sin(nu) * cos(
                                  big_omega) * cos(small_omega) * cos(
                                  i) + (e + cos(nu)) * (-sin(big_omega) * cos(small_omega) - cos(big_omega) * sin(small_omega) * cos(
                                          i)));
    vj[5] = c3 * (-cos(nu) * (sin(big_omega) * cos(small_omega) + cos(big_omega) * sin(
            small_omega) * cos(i)) - sin(
                                  nu) * (-sin(big_omega) * sin(small_omega) + cos(big_omega) * cos(small_omega) * cos(i)));


    double vk[6];
    //it 's not vk, just a notation
    vk[0] = 1 / (2 * a) * c3 * (sin(nu) * sin(small_omega) * sin(i) - (e + cos(nu)) * cos(
            small_omega) * sin(i));
    vk[1] = 1 / (1 - e * e) * c3 * (-e * sin(nu) * sin(small_omega) * sin(i) + (1 + e * cos(
                            nu)) * cos(
                            small_omega) * sin(i));
    //!!!!looks like there s a typo in the equation online cos((w * cos(i)))
    vk[2] = c3 * (-sin(nu) * sin(small_omega) * cos(i) + (e + cos(nu)) * cos(
                                  small_omega) * cos(i));
    vk[3] = 0;
    vk[4] = c3 * (-sin(nu) * cos(small_omega) * sin(i) - (e + cos(nu)) * (sin(
                                  small_omega) * sin(i)));
    vk[5] = c3 * (-cos(nu) * sin(small_omega) * sin(i) - sin(nu) * cos(small_omega) * sin(
                                  i));
...
int compute_T_inrtl_2_ntw(double T_inrtl_2_ntw[3][3],
    ...
    //Algorithm
    /*
     * In-track (in the direction of the velocity even if the
     * eccentricity is not 0 (contrarily to the along-track
     * direction in the LVLH frame))
     */
    v_norm(t, v);
    ...
    for(col = 0; col < 3; col++) {
        ...
        //in - track
        T_inrtl_2_ntw[1][col] = w[col];
        //cross - track
        T_inrtl_2_ntw[2][col] = n[col];
        //in - track cross cross - track
    }
...
int  compute_T_inrtl_2_ntw_6by6(double T_inrtl_2_ntw_6by6[6][6],
    ...
    /*
     * Along-track (different from the velocity direction if the
     * eccentricity is not 0)
     */
    v_cross(t, w, n);
    v_norm(t, t);
    v_scale(t, t, -1.0);
...
/*
 * Inertial to Earth pressure frame. The Earth pressure frame is
 * defined as follow:
 */
/* Notations: */
...
/*
 * - H projection of the satellite lcoation on the surface of the
 * Earth (ie sub-satellite point)
 */
...
int compute_T_inrtl_2_earth_pres_frame(double T_inrtl_2_earth_pres_frame[3][3],
    ...
    if(cos_yep_temp_earth2sun < 0) {
        //we want yep to be in the direction of the Sun.
    ...
    //vector completing the orthogonal basis
...
#swarm%2FLevel1b%2FEntire_mission_data%2FSTRxATT
    ...
    if(file_is_quaternion == 1) {
        ...
        estate[0] = r_i2cg_INRTL[0];
        estate[1] = r_i2cg_INRTL[1];
        estate[2] = r_i2cg_INRTL[2];
        estate[3] = v_i2cg_INRTL[0];
        estate[4] = v_i2cg_INRTL[1];
        estate[5] = v_i2cg_INRTL[2];
        sxform_c("J2000", PARAMS->EARTH.earth_fixed_frame, *et, xform);
        mxvg_c(xform, estate, 6, 6, jstate);
        r_ecef2cg_ECEF[0] = jstate[0];
        r_ecef2cg_ECEF[1] = jstate[1];
        r_ecef2cg_ECEF[2] = jstate[2];
        v_ecef2cg_ECEF[0] = jstate[3];
        ...
        m_x_m(T_sc_to_lvlh, T_ecef_2_lvlh, T_sc_to_ecef);
        //don 't ask me why it' s not m_x_m(T_sc_to_lvlh, T_sc_to_ecef, T_ecef_2_lvlh)...
    } //if attitude is set using quaternions
    ...
    ///////////////////// NOT QUATERNION /////////////////////////////////////////////
        ...
        if(strcmp(attitude_profile, "sun_pointed") != 0) {
            ...
            // Pitch rotation
            pitch_mat[0][0] = cos(theta);
            pitch_mat[0][1] = 0;
            pitch_mat[0][2] = sin(theta);
            pitch_mat[1][0] = 0;
            pitch_mat[1][1] = 1;
            pitch_mat[1][2] = 0;
            pitch_mat[2][0] = -sin(theta);
            pitch_mat[2][1] = 0;
            pitch_mat[2][2] = cos(theta);
            ...
            roll_mat[0][2] = 0;
            roll_mat[1][0] = 0;
            roll_mat[1][1] = cos(phi);
            roll_mat[1][2] = -sin(phi);
            roll_mat[2][0] = 0;
            roll_mat[2][1] = sin(phi);
            roll_mat[2][2] = cos(phi);
            ...
            /*
             * printf("%d %d %d\n", order_rotation[0],
             * order_rotation[1], order_rotation[2]);
             */
        ...
        if(strcmp(attitude_profile, "sun_pointed") == 0) {
            /* Sun-pointed */
            /*
             * Express e_z_body in Inertial frame
             * (J2000)
             */
            ...
            v_norm(e_z_body_in_lvlh_normalized, e_z_body_in_lvlh);
            //useless cause e_z_body_in_lvlh should already be normalized
            ...
            double lvlh_z_in_lvlh[3], new_e_x_body_in_lvlh[3], new_e_y_body_in_lvlh_normalized[3],
                        new_e_x_body_in_lvlh_normalized[3];
            lvlh_z_in_lvlh[0] = 0;
            lvlh_z_in_lvlh[1] = 0;
            lvlh_z_in_lvlh[2] = 1;
            //lvlh_z is in the nadir(oriented away from the Earth)
            ...
            v_cross(new_e_y_body_in_lvlh_normalized, e_z_body_in_lvlh_normalized,
            ...
            double new_e_x_body_in_lvlh_normalized_rotated_10_degrees[3],
                        new_e_x_body_in_lvlh_normalized_rotated_10_degrees_component_along_new_e_x_body_in_lvlh_normalized[3],
                        new_e_x_body_in_lvlh_normalized_rotated_10_degrees_component_along_new_e_y_body_in_lvlh_normalized[3],
                        new_e_x_body_in_lvlh_normalized_rotated_10_degrees_component_along_e_z_body_in_lvlh_normalized[3],
                        new_e_x_body_in_lvlh_normalized_rotated_10_degrees_temp[3],
                        new_e_x_body_in_lvlh_normalized_rotated_10_degrees_normalized[3];
            v_scale(new_e_x_body_in_lvlh_normalized_rotated_10_degrees_component_along_new_e_x_body_in_lvlh_normalized,
                    new_e_x_body_in_lvlh_normalized, cos(10. * DEG2RAD));
            v_scale(new_e_x_body_in_lvlh_normalized_rotated_10_degrees_component_along_new_e_y_body_in_lvlh_normalized,
                    new_e_y_body_in_lvlh_normalized, sin(10. * DEG2RAD));
            new_e_x_body_in_lvlh_normalized_rotated_10_degrees_component_along_e_z_body_in_lvlh_normalized[0] =
                0;
            new_e_x_body_in_lvlh_normalized_rotated_10_degrees_component_along_e_z_body_in_lvlh_normalized[1] =
                0;
            new_e_x_body_in_lvlh_normalized_rotated_10_degrees_component_along_e_z_body_in_lvlh_normalized[2] =
                0;

            v_add(new_e_x_body_in_lvlh_normalized_rotated_10_degrees_temp,
                  new_e_x_body_in_lvlh_normalized_rotated_10_degrees_component_along_new_e_x_body_in_lvlh_normalized,
                  new_e_x_body_in_lvlh_normalized_rotated_10_degrees_component_along_new_e_y_body_in_lvlh_normalized);
            v_add(new_e_x_body_in_lvlh_normalized_rotated_10_degrees,
                  new_e_x_body_in_lvlh_normalized_rotated_10_degrees_temp,
                  new_e_x_body_in_lvlh_normalized_rotated_10_degrees_component_along_e_z_body_in_lvlh_normalized);
            v_norm(new_e_x_body_in_lvlh_normalized_rotated_10_degrees_normalized,
                   new_e_x_body_in_lvlh_normalized_rotated_10_degrees);
            new_e_x_body_in_lvlh_normalized[0] = 0;
            new_e_x_body_in_lvlh_normalized[1] = 0;
            new_e_x_body_in_lvlh_normalized[2] = 0;
            v_copy(new_e_x_body_in_lvlh_normalized,
                   new_e_x_body_in_lvlh_normalized_rotated_10_degrees_normalized);
            new_e_y_body_in_lvlh_normalized[0] = 0;
            new_e_y_body_in_lvlh_normalized[1] = 0;
            new_e_y_body_in_lvlh_normalized[2] = 0;
            v_cross(new_e_y_body_in_lvlh_normalized, e_z_body_in_lvlh_normalized,
                    new_e_x_body_in_lvlh_normalized);
            ...
            /*
             * /\* // // IMPORTANT: IF YOU
             * UNCOMMENT THIS BLOCK THEN COMMENT
             * BLOCK A *\/
             */
            /*
             * /\* // Sun pointed gives the
             * direction of z_body. The sc can
             * still roll around this vector sc
             * to Sun. By default, we assume that
             * the roll angle is so that the
             * x_body points towards lvlh_x. In
             * other words, the projection of
             * lvlv_x on the plane perpendicular
             * to the Sun give x_body *\/
             */
            /*
             * double v_int[3],
             * lvlh_x_in_lvlh[3],
             * new_e_x_body_in_lvlh[3],
             * new_e_y_body_in_lvlh_normalized[3],
             *  v_int_norm[3],
             * new_e_x_body_in_lvlh_normalized[3];
             *
             */
            ...
            /*
             * v_cross(v_int,
             * e_z_body_in_lvlh_normalized,
             * lvlh_x_in_lvlh);
             */
            /* v_norm(v_int_norm, v_int); */
            /*
             * v_cross(new_e_x_body_in_lvlh,
             * v_int_norm,
             * e_z_body_in_lvlh_normalized);
             */
            /*
             * v_norm(new_e_x_body_in_lvlh_normali
             * zed, new_e_x_body_in_lvlh);
             */
            /*
             * v_cross(new_e_y_body_in_lvlh_normal
             * ized, e_z_body_in_lvlh_normalized,
             * new_e_x_body_in_lvlh_normalized);
             */
             ...
             */
            /*
             * /\*   /\\* v_scale(u_dot_n_scale,
             * e_z_body_in_lvlh_normalized,u_dot_n
             * ); *\\/ *\/
             */
            /*
             * /\*   /\\*
             * v_sub(new_e_x_body_in_lvlh_normaliz
             * ed, lvlh_x_in_lvlh,
             * u_dot_n_scale); *\\/ *\/
             */
            /*
            ...
            /*
             * /\*   /\\*
             * v_print(new_e_x_body_in_lvlh_normal
             * ized,
             * "new_e_x_body_in_lvlh_normalized");
             *  *\\/ *\/
             */
             ...
             * expressed in the LVLH frame: the z
             * axis points towards the Sun, and
             * the x axis is the projection of
             * LVLH_X on the plane perdicular to
             * the satellite-to-Sun vector.
             */
                          ...
                          double flattening)//in:flattening parameter
{
    ...
    T_enu_to_east_north_center_earth_to_local[0][1] = 0;
    T_enu_to_east_north_center_earth_to_local[0][2] = 0;
    T_enu_to_east_north_center_earth_to_local[1][0] = 0;
    T_enu_to_east_north_center_earth_to_local[1][1] = cos(rot_angle);
    T_enu_to_east_north_center_earth_to_local[1][2] = sin(rot_angle);
    T_enu_to_east_north_center_earth_to_local[2][0] = 0;
    T_enu_to_east_north_center_earth_to_local[2][1] = -sin(rot_angle);
    ...
    T_east_north_center_earth_to_local_to_ecef[0][1] = -sin(geocentric_latitude) * cos(longitude);
    T_east_north_center_earth_to_local_to_ecef[0][2] = cos(geocentric_latitude) * cos(longitude);
    T_east_north_center_earth_to_local_to_ecef[1][0] = cos(longitude);
    T_east_north_center_earth_to_local_to_ecef[1][1] = -sin(geocentric_latitude) * sin(longitude);
    T_east_north_center_earth_to_local_to_ecef[1][2] = cos(geocentric_latitude) * sin(longitude);
    T_east_north_center_earth_to_local_to_ecef[2][0] = 0;
